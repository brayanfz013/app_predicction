...
pred_series = modelo.predict(
    model=model_trained, data=modelo.tunne_parameter.data, horizont=parameters["forecast_val"]
)
...
filter_date = data_filled[
    (data_filled[date_col] >= metric_columns_pred["init_date"])
