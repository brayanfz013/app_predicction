...
try:
    ...
    from src.models.args_data_model import (ModelBlockRNN, ModelDLinearModel,
                                            ...
                                            ModelNlinearModel, ModelRNN,
                                            ModelTCNModel, ModelTFTModel,
                                            ModelTransformerModel)
except ImportError:
    from args_data_model import (ModelBlockRNN, ModelDLinearModel,
                                 ModelExponentialSmoothing, ModelFFT,
                                 ModelNBEATSModel, ModelNlinearModel, ModelRNN,
                                 ModelTCNModel, ModelTFTModel,
                                 ModelTransformerModel)
...
class ModelHyperparameters:
    ...
    def build_fit_model(self, callbacks=None, enable_callback: bool = False, enable_encoder: bool = False):
        ...
        early_stopper = EarlyStopping(
            "val_loss", min_delta=0.001, patience=10, verbose=True)
