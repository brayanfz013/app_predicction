...
class Market(object):
    ...
    def _init_options(self, **options):
        ...
        self.state_codes = self.codes# + self.index_codes <============ MODIFICACION AL ORIGINAL POR FALTA DE ENTEDIMIENTO
    ...
    #     else:                                               #<============ MODIFICACION DE VISUALIZACION
    #         print('Validation Complete for : '.format(self.state_codes))
    ...
    def _init_data_frames(self, start_date, end_date):
        ...
        for index, code in enumerate(self.state_codes):
            ...
            instrument_docs = self.doc_class.objects(code = code) # <=============MODIFICACION DE LA LINEA SUPERIOR YA QUE NO ACEPTA EL RANGE DEL TIEMPO
        ...
        # Rebuild index. and fill missin data in the DF
        for code in self.state_codes:
